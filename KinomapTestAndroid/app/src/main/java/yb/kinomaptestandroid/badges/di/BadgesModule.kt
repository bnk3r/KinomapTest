package yb.kinomaptestandroid.badges.di
...
import yb.kinomaptestandroid.badges.presentation.categories.CategoriesViewModel
import yb.kinomaptestandroid.badges.presentation.details.BadgeDetailsViewModel
...
val badgesModule = module {
    ...
    viewModel { BadgeDetailsViewModel(get()) }
}